...
import (
	...
	catalogclient "github.com/openresourcebroker/catalog/pkg/client/injection/client"
	brokerinformer "github.com/openresourcebroker/catalog/pkg/client/injection/informers/catalog/v1alpha1/broker"
...
func NewController(
	...
	c := &Reconciler{
		Client:        catalogclient.Get(ctx),
		Lister:        brokerInformer.Lister(),
		ServiceLister: svcInformer.Lister(),
		Recorder: record.NewBroadcaster().NewRecorder(
			scheme.Scheme, corev1.EventSource{Component: controllerAgentName}),
	}
	impl := controller.NewImpl(c, logger, "Broker")
