...
import (
	...
	catalogv1alpha1 "github.com/openresourcebroker/catalog/pkg/apis/catalog/v1alpha1"
	versioned "github.com/openresourcebroker/catalog/pkg/client/clientset/versioned"
	internalinterfaces "github.com/openresourcebroker/catalog/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/openresourcebroker/catalog/pkg/client/listers/catalog/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CatalogV1alpha1().Brokers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogV1alpha1().Brokers(namespace).Watch(options)
			},
		},
		&catalogv1alpha1.Broker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *brokerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&catalogv1alpha1.Broker{}, f.defaultInformer)
}
