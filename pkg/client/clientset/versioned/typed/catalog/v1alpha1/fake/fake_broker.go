...
import (
	v1alpha1 "github.com/openresourcebroker/catalog/pkg/apis/catalog/v1alpha1"
...
var brokersResource = schema.GroupVersionResource{Group: "catalog.orb.dev", Version: "v1alpha1", Resource: "brokers"}

var brokersKind = schema.GroupVersionKind{Group: "catalog.orb.dev", Version: "v1alpha1", Kind: "Broker"}
...
func (c *FakeBrokers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Broker, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(brokersResource, c.ns, name, data, subresources...), &v1alpha1.Broker{})
