...
// CatalogV1alpha1Client is used to interact with features provided by the catalog.orb.dev group.
type CatalogV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CatalogV1alpha1Client) Brokers(namespace string) BrokerInterface {
