				...
				Plans: []osb.Plan{
					{
						...
						Name:        "primary",
						ID:          "5044d9f2-713e-4ff7-9d8e-78bdd591b8d1",
						Description: "The primary plan for the starter pack example service",
						Free:        truePtr(),
						Schemas: &osb.Schemas{
							ServiceInstance: &osb.ServiceInstanceSchema{
								Create: &osb.InputParametersSchema{
						...
						Name:        "rainbow",
						ID:          "815b82f7-ba1f-4e5e-8db1-229cf20c4968",
						Description: "The rainbow plan for the starter pack example service",
						Free:        truePtr(),
						Schemas: &osb.Schemas{
							ServiceInstance: &osb.ServiceInstanceSchema{
								Create: &osb.InputParametersSchema{
									Parameters: map[string]interface{}{
										...
										"properties": map[string]interface{}{
											"color": map[string]interface{}{
												"type":    "string",
												"default": "Orange",
												"enum":    []string{"Orange", "Yellow", "Indigo", "Violet"},
											},
										},
									},
								},
